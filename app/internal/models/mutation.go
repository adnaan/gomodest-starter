...
// operation is accepted only on Task creation.
...
// OldOwner returns the old owner value of the Task.
...
// OldText returns the old text value of the Task.
// If the Task object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// OldCreatedAt returns the old created_at value of the Task.
// If the Task object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
// OldUpdatedAt returns the old updated_at value of the Task.
// If the Task object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
