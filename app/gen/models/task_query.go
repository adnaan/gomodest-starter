...
func (tgb *TaskGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("models: TaskGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TaskGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TaskGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("models: TaskGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TaskGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TaskGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("models: TaskGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TaskGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TaskGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("models: TaskGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TaskGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TaskSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("models: TaskSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TaskSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TaskSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("models: TaskSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TaskSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TaskSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("models: TaskSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TaskSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TaskSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("models: TaskSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TaskSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{task.Label}
	default:
		err = fmt.Errorf("models: TaskSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
